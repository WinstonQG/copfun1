  ...
  <div class="lookbook-actionbar">
    <div class="row">
        <?php if ($exposed): ?>
          ...
          <div class="col-md-8 col-sm-12 list-select-exposed label-inline clearfix">
            <?php print $exposed; ?>
          </div>
        <?php endif; ?>
        <?php if ($header): ?>
          <div class="col-md-2 col-sm-12">
            <p class=""><small class="text-muted"><?php print $header; ?></small></p>
          </div>
        <?php endif; ?>
    </div>
  </div>
