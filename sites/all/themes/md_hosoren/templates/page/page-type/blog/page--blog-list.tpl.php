...
?>
  ...
  <div id="page-wrapper">
    ...
    <div id="main" class="blog-wrapper <?php print $blog_class;?> clearfix">
      ...
      <div class="md-body">
        ...
        <?php endif; ?>
            <?php if ($page['sidebar_first']): ?>
              <?php if($blog_list_right != 'display-none'):?>
                <div class="row">
                    <div class="<?php print $blog_list_left?> blog-list-content">
                        <a id="main-content"></a>
                        <?php print render($title_prefix); ?>
                        <?php print render($title_suffix); ?>
                        <?php if ($tabs): ?>
                          <div id="tabs-menu" class="tabs"><?php print render($tabs); ?></div>
                        <?php endif; ?>
                    ...
                    <div class="<?php print $blog_list_right?>">
              ...
              <?php else:?>
                <div class="row">
                    <div class="col-md-9 col-centered blog-list-content">
                        <a id="main-content"></a>
                        <?php print render($title_prefix); ?>
                        <?php print render($title_suffix); ?>
                        <?php if ($tabs): ?>
