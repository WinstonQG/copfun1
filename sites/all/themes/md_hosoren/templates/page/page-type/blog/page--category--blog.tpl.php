...
?>
  ...
  <div id="page-wrapper">
    ...
    <div id="main" class="blog-wrapper <?php print $blog_class_category?> blog-category-blog clearfix ">
      ...
      <div class="md-body">
        <div class="main-content">
          <div class="container">
            ...
            <div class="row">
                <div class="<?php print $blog_category_left?> blog-list-content">
                    <a id="main-content"></a>
                    <?php print render($title_prefix); ?>
                    <?php print render($title_suffix); ?>
                    <?php if ($tabs): ?>
                ...
                <div class="<?php print $blog_category_right?>">
