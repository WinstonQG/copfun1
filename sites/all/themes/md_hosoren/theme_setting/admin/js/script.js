...
/////////////////////////////////////////////// JQUERY UI TABS ////////////////////////////////////////////////////////
        ...
        $(function () {
            ...
            $("#md-general, #md-design, #md-pages, #md-text-typography,#md-code,#md-config").tabs({
...
(function ($) {
    jQuery(document).ready(function () {
        ...
        $(".md-media-wrapper").delegate(".media-remove-button", 'click', function (event) {
            event.preventDefault();
            var mediaWrapper = $(this).parents(".md-media-wrapper");
            mediaWrapper.find(".img-preview").attr("src", themeDir + '/theme_setting/admin/img/no_image.png');
